                  ...
                  <ul>
                      ...
                      <div className='comment'>
                        <div className='c-data'>
                          <h4 style={{ marginTop: '1rem' }}>
                            {postData?.comment1?.name}
                          </h4>
                          <span>{postData?.comment1?.date}</span>
                          <p style={{ marginBottom: '1rem' }}>
                            {postData?.comment1?.content}
                          </p>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div className='comment reply'>
                        <div className='c-data'>
                          <h4 style={{ marginTop: '1rem' }}>Admin</h4>
                          <p style={{ marginBottom: '1rem' }}>
                            {postData?.comment1?.replyContent}
                          </p>
                          <a className='c-r-btn' href='#.'>
                            A
                          </a>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <div className='row align-items-center form-check'>
                      <div className='col-lg-12 d-flex-all justify-content-start'>
                        ...
                        />
                        <label
                          className='form-check-labell'
                          htmlFor='exampleCheck24'
                        >
                          {' '}
