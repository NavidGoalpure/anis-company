            ...
            <div className='col-lg-6'>
              <div className='pd-data'>
                ...
                <ul className='pd-price'>
                  <li className='pd-sale-price'>
                    <span>$</span>400.00
                  </li>
                  <li className='pd-regular-price'>
                    <span>$</span>500.00
                  </li>
                </ul>
                <p className='free-ship'>Free Shipping On This Item</p>
                <Link href='/cart' className='theme-btn'>
                  Add to Cart <i className='fa-solid fa-angles-right' />
                </Link>
              ...
              <div className='pd-details'>
                <div className='more d-flex align-items-start'>
                  <Tab.Container
                    ...
                    defaultActiveKey='tab-product-0'
                  >
                    <Nav variant='pills' className='nav flex-column nav-pills'>
                      <Nav.Item>
                        <Nav.Link eventKey='tab-product-0'>
                          Description
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link eventKey='tab-product-1'>
                    ...
                    <Tab.Content>
                      <Tab.Pane eventKey='tab-product-0' title='Description'>
                        <div className='des-tab'>
                          <h3>About Product</h3>
                          <p>
                            Galvafroid zinc rich cold galvanising coating is
                            formulated as an easily applied protection against
                            corrosion on all ferrous metals. Galvafroid has a
                            mid-grey, matt finish.
                          </p>
                          <p>
                            new technologies. Our portfolio includes dozens of
                            successfully completed projects of houses of
                            different storeys, with high–quality finishes and
                            good repairs. Building houses is our vocation!
                          </p>
                      ...
                      >
                        <div className='adis-tab'>
                          ...
                          <ul className='include'>
                            <li>
                              <i className='fa-solid fa-check'></i> Pickup
                              available at The Colour Centre
                            </li>
                            <li>
                              <i className='fa-solid fa-check'></i> Protection
                              against corrosion on all ferrous
                            </li>
                            <li>
                              <i className='fa-solid fa-check'></i>{' '}
                              {`Results that improve our clients' performance`}
                            </li>
                            <li>
                              <i className='fa-solid fa-check'></i> Exceptional
                              client experience
                            </li>
                            <li>
                              <i className='fa-solid fa-check'></i> Pickup
                      ...
                      <Tab.Pane eventKey='tab-product-2' title='Reviews'>
                        <div className='rev-tab'>
                          ...
                          <div className='total-reviews d-flex-all justify-content-between'>
                            <div className='t-r d-flex-all'>5.0 Rating</div>
                              ...
                              <li>
                                <div className='comment'>
                                  <div className='c-img'>
                                    <figure>
                                      <img
                                        src='/img/comment-img-3.jpg'
                                        alt='Comment Image One'
                                      />
                                    </figure>
                                  </div>
                                  <div className='c-data'>
                                    ...
                                    <p>
                                      ...
                                      frankness estimable as. Nay any article
